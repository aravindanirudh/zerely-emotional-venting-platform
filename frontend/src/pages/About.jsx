        ...
        <div className="flex flex-col lg:flex-row gap-5 lg:gap-10 justify-center items-center">
          <div className="flex flex-col text-justify justify-center max-w-2xl">
            <p className="lg:text-lg mb-4">
              ...
              overthinking - perfection delaying progress, paralysis by
              analysis. Until one moment forced a decision: stop waiting, stop
              hesitating, and start building. Zerely is the result of that arc -
              proof that the hardest step is simply beginning.
              <br />
              <br />
